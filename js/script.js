...
function start() {
	...
	sum = parseInt(qq) + parseInt(qe);
 	document.open();
 	document.write('<!DOCTYPE html><html><head><link href="https://fonts.googleapis.com/css?family=Roboto&display=swap" rel="stylesheet"><link rel="stylesheet" type="text/css" href="css/style.css"><script type="text/javascript" src="js/script.js"></script><title>GP - Inicio</title></head><body><center>');
